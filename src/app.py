...
from src.agent import CustomAgentExecutor
from src.tools import retrieve, average_price, final_answer, calculate_travel_time, find_places_near_location
...
- Find nearby amenities and calculate travel times
""")
...
# Footer
st.markdown("---")
st.markdown("RealEstatePRO - Powered by LangChain and Google Generative AI")